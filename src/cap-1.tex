...
\end{equation}
\begin{figure}[htb]
\includegraphics[width=0.7\textwidth, ]{figuras/exemplo_polinomio_lagrange.png}
\caption{polinomio base de Lagrange para 6 pontos}
\end{figure}
...
\begin{figure}[h]
  \includegraphics[width=0.7\textwidth, right]{figuras/interpolacao_linear5.png}
...
\end{align}
 ...
 \begin{equation}
  x_1 \approx -1 + \frac{\pi^2}{8N^2} ; x_2 = -1 + \frac{9\pi}{8N^2} [N\gg 1]
 \end{equation}
 
 Tendo calculados temos 