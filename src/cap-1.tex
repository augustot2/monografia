...
\subsection{Integração gaussiana e linhas pseudoespectral}
 ...
 Quando calculamos, os pontos de \emph{interpolação} são nomeados de \bold{abcissas}, enquanto que a \emph{integral} de um polinômio base é chamado de \bold{Pesos de quadratura}, no contexto da integração numérica.
