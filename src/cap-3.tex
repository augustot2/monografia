...
\begin{figure}[H]
\centering
\includegraphics[width=.6\textwidth,center]{figuras/Neumm_1_30.png}
\caption{aproximação do método P de grau 30} 
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth,center]{figuras/Neumm_1_40.png}
\caption{aproximação do método P de grau 40} 
\end{figure}
\begin{figure}[H]
\centering
...
\end{figure}
 Agora, utilizando o método HP, utilizamos um polinômio de grau 20 e aumentando em 1 unidade o número de elementos, observamos o quanto o erro converge rapidamente:\begin{figure}[H]
\centering
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth,center]{figuras/Neumm_3_20.png}
\caption{aproximação do método P de grau 20 e $N_{el} = 3$} 
\end{figure}
\begin{figure}[H]
\centering
